...
public class TadGrafo{
	...
	private int order;//n vertices no grafo
	private int grau;//n arestas no grafo
	...
	public void removerVertice(int v1, int v2){
		//falta implementar
	}
	...
	public int oposto(Object aresta, int linha){
		int i;
		for(i=0; i < matrizAdj.length; i++){
			if(matrizAdj[linha][i] == aresta){
				break;
			}
		}
		return i;
	...
	public void substituir(int v1, int v2, Object valor){
